 ...
 * 
 * Vercel serverless function - automatically handles raw body
 */

const Stripe = require('stripe');
const { createClient } = require('@supabase/supabase-js');
const { resolvePlanCycleFromPriceId, getPlanConfig } = require('../../server/lib/stripePlans');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Vercel provides raw body as string in req.body when bodyParser is disabled
