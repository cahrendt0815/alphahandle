...
// Analysis now handled by /api/analyze endpoint
...
export default function ResultsScreen({ route, navigation }) {
  ...
  useEffect(() => {
    ...
    // Fetch analysis from /api/analyze endpoint
    fetch('/api/analyze', {
      method: 'POST',
      ...
      .then((freshData) => {
        if (mounted) {
          console.log('[ResultsScreen] Analysis data received');
          // Map analyst API response to expected format if needed
          setData(freshData);
          setLoading(false);
